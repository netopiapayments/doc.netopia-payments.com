...
In order to initiate a start payment request you need to have the following fields filled in your request body and headers:

- In the **config** section: **emailTemplate**, **notifyUrl**, **redirectUrl** and **language**
- In the **payment** section:
  - under options: **installments**
  - under instrument: **type**, **account**, **expMonth**, **expYear**, **secretCode**
...
Below are detailed informations about all of them 

-   **config** : The general configuration

    | Variable   | Type   | Description | Required | Belongs to |
    | :---       | :----: | :----      |      :----: |     ---: |
    | **emailTemplate** | string | Template name of email notification | Yes | Operator |
    | **notifyUrl**     | string | Merchant Notify URL                 | Yes | Merchant |
    | **redirectUrl**   | string | Callback URL                       | Yes | Merchant |
    | **language**      | string | Language                             | Yes | Merchant |
